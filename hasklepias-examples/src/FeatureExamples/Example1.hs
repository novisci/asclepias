...
-}
defineIndexSet :: Ord a => [Event Text ExampleModel a] -> IndexSet (Interval a)
...
twoXOrOneY :: [Text] -> [Text] -> [Event Text ExampleModel a] -> Bool
...
--   surgery.
twoMinorOrOneMajor
  :: (Ord a) => AssessmentInterval a -> [Event Text ExampleModel a] -> Bool
