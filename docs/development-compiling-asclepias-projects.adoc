...
[source,conf]
----
include::../hasklepias-main/hasklepias-main.cabal[tag=devel-docs-package-properties]

include::../hasklepias-main/hasklepias-main.cabal[tag=devel-docs-components]
----
