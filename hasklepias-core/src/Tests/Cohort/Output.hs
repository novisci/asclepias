...
rVarList :: Variable
rVarList = rVector "my_list" $ as_list
...
stypeBinary = as_v_binary [True, False] a
  where a = MkStypeAttrs "my_binary" "my_binary_long" (Just StypeOutcome)

stypeNominal :: Stype 'STRSXP
stypeNominal = v_nominal (as_integer [1 :: Integer, 0, 3]) (V.map pack $ V.fromList ["0", "1", "3"]) a
  where a = MkStypeAttrs "my_nominal" "my_nominal_long" (Just StypeOutcome)
...
rVarAtomicOutExp = object [("varTarget", String "RVector"),
...
rVarListOutExp = object [("varTarget", String "RVector"),
...
stypeVarBinaryOutExp = object [("varTarget", String "StypeVector"),
                        ("vals", Array $ V.fromList [Bool True, Bool False]),
                        ("attrs", object [("varType", String "LGLSXP"), ("varName", String "my_stype_binary")]),
                        ("subAttrs", suba)]
                          where suba = object [("short_label", String "my_binary"),
