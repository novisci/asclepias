...
[source,haskell]
----
include::{sourcedir}/FeatureCompose.hs[tag=feature]
----
...
[source,haskell]
----
include::{sourcedir}/FeatureCompose.hs[tag=featureData]
----
...
[source,haskell]
----
include::{sourcedir}/FeatureCompose.hs[tag=missingReason]
----
