...
=======
cohortSpecs :: CohortMapSpec [Event ClaimsSchema Text Day] Featureset (Interval Day)
>>>>>>> Stashed changes
...
=======
evalCohorts :: Monad m =>  Population ([Event ClaimsSchema Text Day]) -> m (CohortMap Featureset (Interval Day))
