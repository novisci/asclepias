...
buildNofXOrNofYWithGap
  ...
  -> Predicate (Event c ClaimsSchema a)
  ...
  -> ComparativePredicateOf2 (AssessmentInterval a) (Event c ClaimsSchema a)
  -> Predicate (Event c ClaimsSchema a)
  -> Definition
...
type NofXOrNofYWithGapArgs
  = ( Natural
    , Predicate (Event Text  ClaimsSchema Int)
    , Natural
    , Int
    , Interval Int -> AssessmentInterval Int
    , ComparativePredicateOf2 (AssessmentInterval Int) (Event Text  ClaimsSchema Int)
    , Predicate (Event Text  ClaimsSchema Int)
    )

type NofXOrNofYWithGapTestCase
  = TestCase
      (F "index" (Interval Int), F "events" [Event Text  ClaimsSchema Int])
      Bool
