...
-- methods.
-- https://hackage.haskell.org/package/interval-algebra-2.0.1/docs/IntervalAlgebra-Core.html#t:Intervallic
...
-- https://hackage.haskell.org/package/interval-algebra-2.0.1/docs/IntervalAlgebra-Core.html#g:5
...
-- https://hackage.haskell.org/package/interval-algebra-2.0.1/docs/src/IntervalAlgebra.Core.html#unionPredicates
...
-- https://hackage.haskell.org/package/interval-algebra-2.0.1/docs/IntervalAlgebra-IntervalUtilities.html
...
-- https://hackage.haskell.org/package/interval-algebra-2.0.1/docs/src/IntervalAlgebra.Core.html#beginerval
...
-- 1 happens to be the 'moment' for Hour, meaning the smallest unit increment for our intervals. 
-- This is given in the IntervalSizeable typeclass definition.
