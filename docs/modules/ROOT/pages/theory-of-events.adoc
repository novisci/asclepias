...
http://book.realworldhaskell.org/read/types-and-functions.html[Real World Haskell]
are excellent for learning. 
...
[source,haskell]
----
include::example$EventDataTheory/Core.hs[tag=eventType]
----
...
[source,haskell]
----
include::example$EventDataTheory/Core.hs[tag=contextType]
----
...
[source,haskell]
----
include::example$EventDataTheory/TheoryTest.hs[tag=exampleEvent]
----
